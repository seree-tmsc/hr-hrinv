                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-2">
                            ...
                            <input type="text" id='edit_ItemCode' class='form-control' disabled>
                            <input type="hidden" id="paramedit_ItemCode" name="paramedit_ItemCode">
                        </div>
                        <div class="col-lg-5">
                            <label style="display: block; text-align: center;">Item Name:</label>
                            <input type="text" id='edit_ItemName' name='edit_ItemName' class='form-control'>
                        </div>
                        <div class="col-lg-2">
                            <label style="display: block; text-align: center;">UOM:</label>
                            <input type="text" id='edit_Uom' name='edit_Uom' class='form-control' disabled>
                        </div>
                    </div>                                    
                </div>
