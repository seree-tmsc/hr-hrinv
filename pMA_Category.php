...
?>        
        ...
        <html>
            <head>
                ...
                <?php require_once("pMA_Category_Script.php"); ?>
            </head>
            ...
            <body style='background-color:LightSteelBlue;'>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p></p>
                            <!--<h5>User Data:</h5>-->
                            <?php include "pMA_Category_List.php"; ?>
                        </div>
                    </div>
                    <!-- ----------------------------------- -->
                    <!-- End content page -->
                ...
                <!-- Modal - Insert Record -->
                <?php require_once("pMA_Category_Insert_Modal.php"); ?>                

                <!-- Modal - View Record -->
                <?php require_once("pMA_Category_View_Modal.php"); ?>

                <!-- Modal - Insert Record -->
                <?php require_once("pMA_Category_Edit_Modal.php"); ?>                
